...
To replicate our results from MASCOTS 2022 (link to paper coming soon) and use our simulator, follow these simple steps. 
...
- **DTS + Testbed Implementation of DNNs**: 
   If the user also wants to reproduce our testbed results, then in addition to the ones needed solely by DTS, the following packages will be required:
   - pickleshare=0.7.5
   - torch==1.4.0
   - torchvision==0.5.0
   - syft==0.2.9
...
This list of steps is done assuming you are working on a machine that uses Python or Jupyter Notebook regularly and just want to replicate our results from Section IV.D. 
...
3. Download or clone our Git repository into a directory of your choice:
   ```
   git clone https://github.com/robinson08/DTS_2022.git
   ```
